...
def get_neighbor_indices(
    ...
    Example usage:
    ```python
    from sim3D.boundaries import get_neighbor_indices, BoundaryDirection
...
class BoundaryMetadata:
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import BoundaryMetadata, SpatialBoundary
...
class NoFlowBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import NoFlowBoundary, GridBoundaryCondition, get_neighbor_indices
...
class ConstantBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import ConstantBoundary, GridBoundaryCondition
...
class VariableBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import VariableBoundary, BoundaryDirection, get_neighbor_indices
...
class SpatialBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import SpatialBoundary, BoundaryMetadata, GridBoundaryCondition
...
class TimeDependentBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import TimeDependentBoundary, BoundaryMetadata, GridBoundaryCondition
...
class LinearGradientBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import LinearGradientBoundary, BoundaryMetadata, GridBoundaryCondition
...
class FluxBoundary(typing.Generic[NDimension]):
    ...
    ```python
    import numpy as np
    from sim3D.boundaries import FluxBoundary, BoundaryMetadata, GridBoundaryCondition
