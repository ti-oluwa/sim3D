...
def _make_hashable(obj: typing.Any) -> typing.Any:
    ...
    from sim3D.wells.base import Well, Wells
...
def _get_cell_mask(
    ...
    """
    from sim3D.wells.base import _expand_intervals, Well, Wells
...
class Cells:
    ...
    Examples:
    ```python
    from sim3D.wells import Well, Wells, InjectionWell, ProductionWell
